...
import Retail_Bookstore.IntegrationTest;
...
public class LoginFunctionalTest {
	...
	public void loginSuccess() {
        driver.get("http://localhost:6080/Retail_Bookstore");
	...
	public void registrationSuccess() {
        driver.get("http://localhost:6080/Retail_Bookstore/register.jsp");
        ...
        button.click();
        assertTrue(driver.getPageSource().contains("Online Application"));
	}
	
	@Test
	public void forgotPasswordSuccess() {
        driver.get("http://localhost:6080/Retail_Bookstore/forgotpassword.jsp");      
